<?php
	...
	*/
	...
	$config['area_riservata']['lun']['ml']['orario_apertura'] = '13:00';
	...
	$config['area_riservata']['mar']['ml']['orario_apertura'] = '13:00';
	$config['area_riservata']['mar']['ml']['giorno_chiusura'] = -6; 
	$config['area_riservata']['mar']['ml']['orario_chiusura'] = '23:59';

	$config['area_riservata']['mer']['ml']['giorno_apertura'] = -9; 
	$config['area_riservata']['mer']['ml']['orario_apertura'] = '13:00';
	...
	$config['area_riservata']['gio']['ml']['orario_apertura'] = '13:00';
	$config['area_riservata']['gio']['ml']['giorno_chiusura'] = -8; 
	$config['area_riservata']['gio']['ml']['orario_chiusura'] = '23:59';

	$config['area_riservata']['ven']['ml']['giorno_apertura'] = -11; 
	$config['area_riservata']['ven']['ml']['orario_apertura'] = '13:00';
