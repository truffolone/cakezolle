<?php
	...
	*/
	...
	$config['area_riservata']['lun']['ml']['orario_apertura'] = '17:00';
	$config['area_riservata']['lun']['ml']['giorno_chiusura'] = -1; 
	$config['area_riservata']['lun']['ml']['orario_chiusura'] = '23:59';
 
	$config['area_riservata']['mar']['ml']['giorno_apertura'] = -8; 
	$config['area_riservata']['mar']['ml']['orario_apertura'] = '17:00';
	$config['area_riservata']['mar']['ml']['giorno_chiusura'] = -2; 
	$config['area_riservata']['mar']['ml']['orario_chiusura'] = '23:59';

	$config['area_riservata']['mer']['ml']['giorno_apertura'] = -9; 
	$config['area_riservata']['mer']['ml']['orario_apertura'] = '17:00';
	$config['area_riservata']['mer']['ml']['giorno_chiusura'] = -3; 
	$config['area_riservata']['mer']['ml']['orario_chiusura'] = '23:59';

	$config['area_riservata']['gio']['ml']['giorno_apertura'] = -10; 
	$config['area_riservata']['gio']['ml']['orario_apertura'] = '17:00';
	$config['area_riservata']['gio']['ml']['giorno_chiusura'] = -4; 
	$config['area_riservata']['gio']['ml']['orario_chiusura'] = '23:59';

	$config['area_riservata']['ven']['ml']['giorno_apertura'] = -11; 
	$config['area_riservata']['ven']['ml']['orario_apertura'] = '17:00';
	$config['area_riservata']['ven']['ml']['giorno_chiusura'] = -5; 
