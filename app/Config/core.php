 ...
 */
	Configure::write('Exception', array(
		...
		'renderer' => 'CustomExceptionRenderer', //'ExceptionRenderer',
		'log' => true
	));
 ...
 */
	Configure::write('Security.salt', 'DYhG7uYHj?dfl&GtvniR2G7bxWwssC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76859563468976553645');
